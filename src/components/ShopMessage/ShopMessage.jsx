...
const ShopMessage = ({ selectedProduct, currentImage, selectedRom, selectedColor, price }) => {
    return (
        <div className="shop-message">
            <div className="shop-message__info">
                <h2>Товар добавлен в корзину!</h2>
                <div className="shop-message__content">
                    <div className="shop-message__image"><img src={currentImage} alt={selectedProduct} /></div>
